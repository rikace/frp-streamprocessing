...
//        let imageSideEffet = saveImageAgent         
//        let broadcastAgent2 = broadcastAgent [downloadAgent; imageSideEffet]
//        let linkParserAgent = linkParserAgent broadcastAgent2
//        let imageParserAgent = imageParserAgent broadcastAgent2
//        let bradcastAgent1 = broadcastAgent [ linkParserAgent ]
//        let downloadAgent = fetchContetAgent 10 bradcastAgent1
//        
